...
NOEFFECT_K2_N_n40_40_SDR2<-read_sample(ssdossier="without effect/normal/",k=2,distName=rep("normal",2),n=c(40,40),m=c(0,0),sds=c(2,4))
NOEFFECT_K3_N_n40_40_SDR2<-read_sample(ssdossier="without effect/normal/",k=3,distName=rep("normal",3),n=c(40,40,40),m=c(0,0,0),sds=c(2,2,4))
...
graphique(name="NOEFFECT_K2_N_n40_40_SDR2",var=NOEFFECT_K2_N_n40_40_SDR2)
graphique(name="NOEFFECT_K3_N_n40_40_SDR2",var=NOEFFECT_K3_N_n40_40_SDR2)

######## FIGURE 5: comparing power of normal, doublex and mixed normal distribution

######## FIGURE 6: comparing power of normal, doublex and mixed normal distribution
